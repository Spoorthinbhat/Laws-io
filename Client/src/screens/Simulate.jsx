...
//         if (!response.ok) {
//         throw new Error("Failed to fetch court simulation");
//       }
...
//     "friendly_lawyer": "../assets/LadyLawyer.png",
//     "old_man":{old_man},
//     "Person":{UncleMan},
//     "woman":{woman}
// }
//   useEffect(() => {
//     simulateCourt(); // Fetch data on component mount
//   }, []);
...
//             <div className="flex flex-col md:flex-row items-end space-x-4 md:space-y-0">
//               <img
//                 src={MaleLawyer}
//                 alt="Male Lawyer"
...
//             </div>
//           ) : (
//             <div className="flex flex-row md:flex-row-reverse items-center space-x-4 space-y-4 md:space-y-0">
//               <img
//                 src={LadyLawyer}
//                 alt="Female Lawyer"
//                 className="h-[50vh] md:h-[75vh] w-auto"
//               />
//               <div className="bg-gray-100 p-4 rounded-xl shadow-md w-full md:w-7/12 text-xl text-right text-black">
//                 <p>{currentText}</p>
//               </div>
//             </div>
//           )}
...
//       {/* Reason Section */}
//       <div
//         className="fixed bottom-0 w-9/12 bg-gray-800 text-white p-4"
//         style={{
//           display: reason ? "block" : "none", // Only display if there is a reason
//         }}
//       >
    ...
    >
      {contextVisible ? (
        ...
        <div className="flex flex-col md:flex-row w-full h-full">
          ...
          {/* Conversation Section */}
          <div className="md:w-full flex flex-col items-end justify-center p-4">
            <div className={`flex ${currentSpeaker === "opposing_lawyer" ? "flex-col md:flex-row items-end space-x-4" : "flex-row md:flex-row-reverse items-center space-x-4"}`}>
              <img
